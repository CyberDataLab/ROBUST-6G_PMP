...
def get_active_interfaces():
    ...
    return [iface for iface in os.listdir(net_path)]# if iface != "lo"] #Uncomment this if you do not wish to include the loopback interface

def select_best_interface():

    interfaces = get_active_interfaces()
    
    wired_prefixes = ("eth", "en", "eno", "enp", "ens", "cni", "lo") # Remove loopback ("lo") interface if you wish
